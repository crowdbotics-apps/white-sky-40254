"""
Django settings for white_sky_40254 project.
...
ROOT_URLCONF = 'white_sky_40254.urls'
...
WSGI_APPLICATION = 'white_sky_40254.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_sky_40254 API",
    "DESCRIPTION": "API documentation for white_sky_40254 App",
    "VERSION": "v1",
}
